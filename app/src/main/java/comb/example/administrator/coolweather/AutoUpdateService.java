...
public class AutoUpdateService extends Service {
    ...
    @Override
    public int onStartCommand(Intent intent,int flags, int startId) {   //onStartCommand此方法调用以下两种方法
        updateWeather();  //更新天气，更新后的数据储存到Share~~
        updateBingPic();  //更新图片
    ...
    private void updateWeather() {
        ...
        if (weatherString != null){
            ...
            String weatherUrl = "http://guolin.tech/api/weather?city = " +
                    weatherId + "&key = e394c88dbbe64b35809168e49aa9efbc";
